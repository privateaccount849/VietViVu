                            ...
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 81.2875px;">Description</th>
                                    ...
                                    <?php for ($i = 0; $i < count($results->data); $i++) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="News/updateNews.php?id=<?php echo $results->data[$i]['Id']; ?>">Update</a>
                                                        <a class="dropdown-item" href="news.php?delete=<?php echo $results->data[$i]['Id']; ?>">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <?php
                                            if (isset($_GET['delete'])) {
                                                $TourId = $_GET['delete'];
                                                $sql = "delete from news where Id=$TourId";
