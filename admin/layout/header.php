<head>
    ...
    <link href="<?php echo  WEB_ASSETS; ?>/admin/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">
        
    <!-- Custom styles for this template-->
    <link href="<?php echo  WEB_ASSETS; ?>/admin/css/sb-admin-2.min.css" rel="stylesheet">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo  WEB_ASSETS; ?>/admin/news.php">List News</a>
                        <a class="collapse-item" href="<?php echo  WEB_ASSETS; ?>/admin/news/createNews.php">Create News</a>
                    </div>
                </div>
            </li>
